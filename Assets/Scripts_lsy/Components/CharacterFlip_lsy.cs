...
public class CharacterFlip_lsy : CharacterComponents_lsy
{
    ...
    protected override void HandleAbility()
    {
        ...
        if (flipMode == FlipMode.WeaponDirection)
        {
             FlipToMoveDirection();
            //FlipToWeaponDirection();
        }
        else if(flipMode == FlipMode.MovementDirection)
         {
            FlipToMoveDirection();
        }
    }
    ...
    {
        if (characterWeapon != null || playerWeapon != null)
        {
